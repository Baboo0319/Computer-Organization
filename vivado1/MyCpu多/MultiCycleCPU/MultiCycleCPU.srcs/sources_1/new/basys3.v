...
wire [31:0] regRs; //寄存器组rs寄存器的地址
wire [31:0] regRt; //寄存器组rt寄存器的地址
...
multiCycleCPU my_SCPU(myCLK, Reset, regRs, regRt, Opcode, Out1, Out2, curPC, nextPC, Result, DBData, Instruction); //CPU
