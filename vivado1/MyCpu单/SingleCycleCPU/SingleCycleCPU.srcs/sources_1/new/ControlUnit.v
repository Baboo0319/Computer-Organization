...
// 根据opcode定义控制信号为1或0
assign PCWire = (OpCode == 6'b111111) ? 0 : 1;
...
assign RegWire = (OpCode == 6'b101011 || OpCode == 6'b000100 || OpCode == 6'b000101 || OpCode == 6'b000010) ? 0 : 1;
assign InsMemRW = 1;
assign RD = (OpCode == 6'b100011) ? 0 : 1;
...
assign ALUOp[1] = (OpCode == 6'b001101 || OpCode == 6'b001010 || (OpCode == 6'b000000 && func == 6'b100101) ||( OpCode == 6'b000000 && func == 6'b100010)) ? 1 : 0;
assign ALUOp[0] = ((OpCode == 6'b000000 && func == 6'b100101) || OpCode == 6'b000100 || OpCode == 6'b000101 || OpCode == 6'b001101 || (OpCode == 6'b000000 && func == 6'b100010) || OpCode == 6'b000110) ? 1 : 0;
